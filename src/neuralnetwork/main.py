...
async def main():
    repo: Repository = get_repository()
    fighter1: DBFighter = await repo.fighter.get_by_name("Конор Макгрегор")  #сюда первого бойца
    fighter2: DBFighter = await repo.fighter.get_by_name("Хабиб Нурмагомедов")  #сюда второго бойца
