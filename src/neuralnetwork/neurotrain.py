...
# data["total_fights"] = data["wins_count"] + data["defeats_count"]
# data["win_loss_ratio"] = data["wins_count"] / (data["defeats_count"] + 1)
# data["activity_index"] = data["wins_count"] / data["total_fights"]
# data["popularity_index"] = (data["wins_count"] - data["defeats_count"]) / data["total_fights"]
